...
stagingComponent = {
  ...
  methods: {
    ...
    downloadSelected: function() {
      var continueFlag, query;
      console.log("downloading selected");
      if (this.selected.length > 10) {
        continueFlag = true;
        BootstrapDialog.confirm("Only ten files can be downloaded at one time. See download instructions for downloading more at one time", function(goAhead) {
          return continueFlag = goAhead;
        });
      }
      if (!continueFlag) {
        return;
