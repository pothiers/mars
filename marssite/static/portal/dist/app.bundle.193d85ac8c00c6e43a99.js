...
/* harmony default export */ __webpack_exports__["a"] = (Results = {
  ...
  computed: {
    categoriesLoaded: function(){
      return !__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isEmpty(this.categories);
    }
  },
  methods: {
    ...
    toggleColumn: function(column) {
      ...
      if (column.checked) {
        ...
        for (n = i = 0, len = ref.length; i < len; n = ++i) {
          col = ref[n];
          if (__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.isEqual(col, column)) {
    ...
    bus.$on("rowselected", (function(_this) {
      return function(data) {
        ...
        if (data.isSelected) {
          ...
          index = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.indexOf(_this.selected, data.row);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "row"
  }, [(_vm.categorizeFirst) ? _c('div', {
    staticClass: "col-xs-12 results-categories"
  ...
  }, [_vm._v("Show Categories")])]) : _vm._e()]) : _vm._e()])]), _vm._v(" "), _c('div', {
    staticClass: "container"
  }, [_c('div', {
    staticClass: "row"
  }, [(_vm.categoriesVisible) ? _c('div', {
    staticClass: "col-md-3 col-xs-12"
  }, [(!_vm.categoriesLoaded) ? _c('div', {
    staticClass: "loading-wrapper text-center"
  }, [_c('h4', [_vm._v("Analyzing results. Loading categories...")]), _vm._v(" "), _c('div', {
    staticClass: "fa fa-spin fa-spinner fa-3x fa-fw"
  })]) : _vm._e(), _vm._v(" "), _vm._l((_vm.categories), function(cat, indx) {
    return _c('ul', {
