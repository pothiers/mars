...
from djangocalendar.settings import (GET_EVENTS_FUNC, OCCURRENCE_CANCEL_REDIRECT,
...
class CalendarByPeriodsView(CalendarMixin, DetailView):
    template_name = 'calendar/calendar_by_period.html'
...
class OccurrenceView(OccurrenceMixin, DetailView):
    template_name = 'calendar/occurrence.html'
...
class EditOccurrenceView(OccurrenceEditMixin, UpdateView):
    template_name = 'calendar/edit_occurrence.html'
...
class CancelOccurrenceView(OccurrenceEditMixin, ModelFormMixin, ProcessFormView):
    template_name = 'calendar/cancel_occurrence.html'
...
class DeleteEventView(EventEditMixin, DeleteView):
    template_name = 'calendar/delete_event.html'
