...
urlpatterns = [
    ...
    url(r'^tri_month/(?P<calendar_slug>[-\w]+)/$',
        CalendarByPeriodsView.as_view(template_name='calendar/calendar_tri_month.html'),
        name='tri_month_calendar',
        kwargs={'period': Month}),

    url(r'^compact_month/(?P<calendar_slug>[-\w]+)/$',
        CalendarByPeriodsView.as_view(template_name='calendar/calendar_compact_month.html'),
        name='compact_calendar',
        kwargs={'period': Month}),

    url(r'^month/(?P<calendar_slug>[-\w]+)/$',
        CalendarByPeriodsView.as_view(template_name='calendar/calendar_month.html'),
        name='month_calendar',
        kwargs={'period': Month}),

    url(r'^week/(?P<calendar_slug>[-\w]+)/$',
        CalendarByPeriodsView.as_view(template_name='calendar/calendar_week.html'),
        name='week_calendar',
        kwargs={'period': Week}),

    url(r'^daily/(?P<calendar_slug>[-\w]+)/$',
        CalendarByPeriodsView.as_view(template_name='calendar/calendar_day.html'),
        name='day_calendar',
        kwargs={'period': Day}),
    ...
    url(r'^$', ListView.as_view(queryset=Calendar.objects.all()), name='calendar'),
]
