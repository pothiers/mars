...
from djangocalendar.settings import CHECK_EVENT_PERM_FUNC, CHECK_CALENDAR_PERM_FUNC, SCHEDULER_PREVNEXT_LIMIT_SECONDS
from djangocalendar.models import Calendar
from djangocalendar.periods import weekday_names, weekday_abbrs

register = template.Library()


@register.inclusion_tag('calendar/_month_table.html', takes_context=True)
...
@register.inclusion_tag('calendar/_day_cell.html', takes_context=True)
...
@register.inclusion_tag('calendar/_daily_table.html', takes_context=True)
...
@register.inclusion_tag('calendar/_event_title.html', takes_context=True)
...
@register.inclusion_tag('calendar/_event_options.html', takes_context=True)
...
@register.inclusion_tag('calendar/_create_event_options.html', takes_context=True)
...
@register.inclusion_tag('calendar/_prevnext.html')
...
@register.inclusion_tag('calendar/_detail.html')
