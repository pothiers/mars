    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(to='djangocalendar.Calendar', verbose_name='calendar', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(blank=True, null=True, to='djangocalendar.Calendar', verbose_name='calendar', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distinction', models.CharField(null=True, max_length=20, verbose_name='distinction')),
                ('content_type', models.ForeignKey(to='contenttypes.ContentType', on_delete=models.CASCADE)),
                ('event', models.ForeignKey(to='djangocalendar.Event', verbose_name='event', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='event',
            name='rule',
            field=models.ForeignKey(blank=True, null=True, to='djangocalendar.Rule', verbose_name='rule', help_text="Select '----' for a one time only event.", on_delete=models.CASCADE),
